...
FROM poverty
INNER JOIN transformed_poverty_disadv_table ON poverty.dbn = transformed_poverty_disadv_table.dbn
INNER JOIN transformed_poverty_not_disadv_table ON poverty.dbn = transformed_poverty_not_disadv_table.dbn
WHERE cohort = '4 year June'
ORDER BY dbn, cohort_year DESC